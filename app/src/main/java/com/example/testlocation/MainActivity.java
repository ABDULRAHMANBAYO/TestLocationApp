...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final int ALL_PERMISSIONS_RESULT = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Add permission need to request
    ...
    private void checkPlayServices() {
        ...
        if (errorCode != ConnectionResult.SUCCESS) {
            Dialog errorDialog = GoogleApiAvailability.getInstance().getErrorDialog(this, errorCode, errorCode,
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                if (location != null) {
                    locationTextView.setText(MessageFormat.format("Latitude: {0}Longitude: {1}",
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(
                                    MainActivity.this).setMessage("These permissions are mandatory to get location")
